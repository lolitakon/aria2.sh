...
echo && echo -e " Aria2 一键安装管理脚本 增强版 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}maded by \033[1;35mP3TERX.COM\033[0m fixed by\033[1;35m @lolitakon(https://github.com/lolitakon/)\033[0m
